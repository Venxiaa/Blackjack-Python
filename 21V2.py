#this is my first public project, nothing crazy just blackjack
#i kind of wanted to learn about classes so i wrote this
...
xray = False
win_button = False
menu_commands = ["play", "balance", "exit", "cheats"]
while True:
    command = input(f"Commands: {", ".join(menu_commands)}: ").strip().lower()
        ...
        if bet_placed:
            ...
            while True:
                ...
                if game_command == "hit":
                    ...
                    break
                elif game_command == "deck" and xray:
                    print(f"next 5 upcomming cards: {', '.join(deck.available_cards[:5])}")
                elif game_command == "dealer" and xray:
            ...
            #------Dealer Logic------
            while player_bust == False and dealer_bust == False:
